    ...
    ui(new Ui::programmationTache)
{
    ...
    ui->duree->setTimeRange(QTime::fromString("00:01","HH:mm"), QTime::fromString(ui->label_duree_2->text(),"HH:mm"));
...
{
    if(ui->statut->currentText() != "Non-Programmée" && !ui->tache->currentText().isEmpty()) //faire un operateur d'addition pour comparer fin+durée et comparer avec pred et succ
    {
